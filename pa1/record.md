...
Perspective matrix is build on assumptions below:<br>
    ...
    3)The mid dot of far plain remain same position after squeezing.<br>
...
$$
    ...
    \end{matrix}
$$
Multipile the matrix with vector\[0,0,f,1\]$^T$ and \[0,0,n,1\]$^T$ resprents the postion of dot in assumption 2) and 3),we should get the equalation:
$$
\begin{cases}
    Af+b=f^2\\
    An+B=n^2
