...
<br>同理, b1 = $\mathbf{S}$ $\cdot$ $\mathbf{S}$<sub>2</sub> / $\mathbf{E}$<sub>1</sub> $\cdot$ $\mathbf{S}$<sub>1</sub>}.
<br>b2 = $\mathbf{D}$ $\cdot$ $\mathbf{S}$<sub>1</sub> / $\mathbf{E}$<sub>1</sub> $\cdot$ $\mathbf{S}$<sub>1</sub>}.
